...
public final class DriveUtils {
	 ...
	 * 
	 * @parm x the x component of the vector
	 * @parm y the y compnent of the vector
	 * @parm angle the angle to rotate the vector
	...
	public static void normalize(double wheelSpeeds[]) {
		...
		// If the max is greater than 1.0, reduce all the values down 
		// proportionally so the max becomes 1.0
		if (maxMagnitude > 1.0) {
			for (double i : wheelSpeeds) {
				i = i / maxMagnitude;
			}
